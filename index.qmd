...
#| label: tt-split
#| message: false
X = AllDaysWithTornados.drop(['tornado_occurred', 'date'], axis = 1)
y = AllDaysWithTornados['tornado_occurred']
...
feature_names = [
    'temperature_2m_mean', 'precipitation_sum', 'dew_point_2m_mean',
    'wind_direction_10m_dominant', 'surface_pressure_mean',
    'wind_gusts_10m_max', 'wind_speed_10m_max', 'relative_humidity_2m_mean'
]
