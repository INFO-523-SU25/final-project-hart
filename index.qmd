...
For this analysis I chose to create and tune 4 different classification models. 
...
logreg_grid = RandomizedSearchCV(logreg_model, param_distributions = logreg_params, cv = 5, scoring = 'accuracy', n_iter = 100, random_state = 63)
...
bayes_grid = RandomizedSearchCV(bayes_model, param_distributions = bayes_params, cv = 5, scoring = 'accuracy', n_iter = 100, random_state = 63)
```
...
svc_grid = RandomizedSearchCV(svc_model, param_distributions = svc_params, cv = 5, scoring = 'accuracy', n_iter = 100, random_state = 63)
...
rf_grid = RandomizedSearchCV(rf_model, rf_params, cv = 5, scoring = 'accuracy', n_iter = 100, random_state = 63)
...
models = [best_logreg_model, best_bayes_model, best_svc_model, best_rf_model]
