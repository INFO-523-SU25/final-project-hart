...
Clean2Raw['date'] = date
Clean2Raw['date'] = pd.to_datetime(Clean2Raw['date'])
Clean2Raw.set_index('date')
# Clean2Raw.info()
# Clean2Raw.head()

MergeRaw = pd.merge(FilteredRaw, Clean2Raw, on='date')
...
MergeFiltRaw = MergeRaw[MergeRaw['CZ_NAME_STR'].isin(counties_list)]
MergeFiltRaw.to_csv('data/tornado_days.csv')
print(MergeFiltRaw.info())
MergeFiltRaw.head()
```
