...
TODO: ADD MAP FOR VISUAL OF THE AREA OF INTEREST
...
'HistoricRaw.info()
My plan is to use ths to get the conditions on days where tornados occurred. This will be were most of the model data is derived from. A data dictionary can be seen in the data_dictionary/README.md
...
|---------|:-----------|--------------------------------------------------------------------:|:------------|
| 1       | 7/28->8/1  | Search and Find Data                                                | Complete    |
| 2       | 8/4->8/8   | Create Proposal and Load and Make Data Dict and Clean Data          | In Progress |
| 2.5     | 8/7->8/10  | Perform EDA and Create Engineering Features and Start Write Up      | In Progress |
...
| 4       | 8/18->8/20 | Finish Write Up and Finish Presentation                             | Not Started |

: Analysis Weekly Attack Plan
