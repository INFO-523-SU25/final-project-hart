...
1. Can I classify the weather conditions of different major weather events using daily data (i.e. Can I say this weather is indicitave of a sunny day, or severe thurnderstorm, or drizzling)

2. Can I build a model to predict tornado occurance given a daily weather 
...
| 3.5     | 8/14->8/17 | Tune and Validate Classification and Regression and Add to Write Up | Not Started | 8/15          |
